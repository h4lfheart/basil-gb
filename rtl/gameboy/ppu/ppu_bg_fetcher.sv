...
module ppu_bg_fetcher(
    ...
    input logic [7:0] SCX,
    input logic [7:0] SCY,
    input logic LCDC_BG_TILE_MAP,
    input logic LCDC_TILE_DATA_MAP,
    ...
    always_comb begin
        ...
        tile_map_base = LCDC_BG_TILE_MAP ? 13'h1C00 : 13'h1800;
        tile_map_offset = {ty, tx};
    end

    logic [12:0] tile_data_base;
    assign tile_data_base = LCDC_TILE_DATA_MAP
        ? {tile_id, 4'b0}
